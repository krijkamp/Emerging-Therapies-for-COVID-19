...
ci_eff_size_vent <- c( 0.51,	0.81)

n_costs     <- 1.995                 # cost of the drug 
ci_costs    <- c(1.425, 2.565)     # confidence interval costs drug 
n_Trt       <- 7                   # number of required doses of the treatment

LOS_Trt      <- 12            # Length of stay with the therapy
LOS_noTrt    <- 13            # Length of stay without the therapy
